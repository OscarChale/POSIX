...
2)echo "https://drive.google.com/file/d/1aZKnKQ9zXwL9tZyqZZNWzMbOaeIneCGf/view";;
...
case $choice in
1)cat "P3/Hackerrank" | display "hackerrank.png";;
2)     menu_herramientas;;
3)cat "P3/Proyecto/CIS-Ubuntu-Linux-LTS-Benchmark.sh";;
4)cat "P3/ProyectoMenu/menu.sh" echo -e "\n\nSelecciona: 5 para salir";;
5) clear
   menu_tareas_P3
   tareas_option3;;
6) clear
